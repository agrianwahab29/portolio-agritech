# PRD — AgrianTech Interactive GSAP Portfolio (v2.0 ULTRA COMPLEX)

**Nama Produk:** AgrianTech Portfolio
...
AgrianTech Portfolio adalah website portofolio profesional milik **Agrian Wahab** yang dirancang untuk memperkuat personal branding sebagai **Web Developer, System Information Developer, UI/UX enthusiast, technical documentation builder, AI-assisted developer, dan fresh graduate Teknik Informatika dengan pengalaman proyek instansi pemerintah**.

Website ini WAJIB terlihat premium, modern, cepat, mudah dibaca, dan BERBEDA dari portofolio biasa. Fokus utama bukan hanya menampilkan CV, tetapi membangun persepsi bahwa AgrianTech mampu membangun produk web yang rapi, interaktif, terstruktur, dan siap dipresentasikan ke perusahaan.
...
> Bagaimana membuat website personal yang terlihat serius, modern, dan meyakinkan perusahaan bahwa AgrianTech bukan sekadar fresh graduate, tetapi calon talenta yang sudah punya bukti proyek nyata di instansi pemerintah?

---

## 3. Visi Produk

> AgrianTech menjadi etalase digital yang menunjukkan bahwa Agrian Wahab mampu membangun web modern, sistem informasi, dan produk digital yang rapi, fungsional, terdokumentasi, dan layak digunakan di lingkungan profesional.
...
Membangun website portofolio profesional dengan brand **AgrianTech** yang mampu menarik perhatian perusahaan, recruiter, klien, dan partner kerja dalam 5 detik pertama.
...
> AgrianTech adalah personal technology brand milik Agrian Wahab yang berfokus pada pengembangan web, sistem informasi, UI/UX, dokumentasi teknis, optimasi performa, dan AI-assisted development untuk membangun solusi digital yang rapi, modern, dan bermanfaat.
...
| Aspek | Fresh Graduate Biasa | AgrianTech |
|-------|---------------------|------------|
...
Website harus menonjolkan bahwa AgrianTech memiliki kekuatan pada:
...
**Plus:**
- Logo AgrianTech (kiri, link ke Home)
...
1. Logo AgrianTech fade + slide dari kiri (0.6s).
...
| 3 | Badge AgrianTech Portfolio | fadeUp 20px + opacity | 0.6s | 0.4s | power3.out |
...
**Hero Section:**
- Badge: AgrianTech Portfolio (chip dengan dot indicator)
...
- Subheading: Selected work from AgrianTech
...
**Title Template:**
```txt
%s | AgrianTech - Agrian Wahab
```n
**Default Title:**
```txt
AgrianTech - Agrian Wahab Portfolio
```n
**Description:**
```txt
...
**Keywords:**
```txt
Agrian Wahab, AgrianTech, Web Developer, Next.js Developer, React Developer, Portfolio Developer Indonesia, System Information Developer, UI UX, Technical Documentation, Fresh Graduate Teknik Informatika, Sulawesi Tenggara Developer
```n
### 27.2 Open Graph

- og:title: AgrianTech - Interactive Developer Portfolio
- og:description: Explore web projects, system information projects, publications, and professional experience by Agrian Wahab.
- og:image: /images/og/agriantech-og.png (1200x630)
- og:type: website
- og:locale: id_ID
...
- Projects: Projects | AgrianTech
- Project Detail: [Project Name] | AgrianTech Case Study
- About: About | AgrianTech
- Publications: Publications | AgrianTech
- Contact: Contact | AgrianTech
...
```txt
Tertarik bekerja sama, berdiskusi tentang peluang kerja, atau membangun sistem digital bersama AgrianTech? Mari terhubung.
```n
---
...
5. Logo AgrianTech wordmark (SVG).
...
1. Wordmark: `AgrianTech` (font Plus Jakarta Sans Bold)
2. Monogram: `AT` (geometric, untuk favicon)
3. With tagline: AgrianTech | Modern Web & Information Systems
...
2. Brand AgrianTech terlihat jelas di hero dan navbar.
...
8. Brand AgrianTech terlihat jelas dan profesional.

---

**Disusun untuk Bos Agrian (Agrian Wahab) | AgrianTech | v2.0 ULTRA COMPLEX**
